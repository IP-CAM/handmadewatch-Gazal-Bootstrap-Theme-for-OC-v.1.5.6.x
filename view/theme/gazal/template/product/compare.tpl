<?php echo $header; ?>
<?php if ($success) { ?>
<div class="success"><?php echo $success; ?><img src="catalog/view/theme/gazal/image/close.png" alt="" class="close" /></div>
<?php } ?>
  ...
  <table class="compare-info">
    ...
    <tbody>
      ...
      <tr>
        ...
        <?php foreach ($products as $product) { ?>
        <td><img src="catalog/view/theme/gazal/image/stars-<?php echo $products[$product['product_id']]['rating']; ?>.png" alt="<?php echo $products[$product['product_id']]['reviews']; ?>" /><br />
    ...
    <tr>
      <td></td>
      <?php foreach ($products as $product) { ?>
      <td><div class="cart"><input type="button" value="<?php echo $product['button_cart']; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button" />
	  <a class="button" style="" /><?php echo $product['fast_order']; ?></a>
	  </div></td>
      <?php } ?>
    </tr>
    <tr>
