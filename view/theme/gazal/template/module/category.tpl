<div class="box category">
  <div class="box-heading">Каталог&nbsp;&nbsp;<div class="clock"></div></div>
    ...
    <div class="box-category">
      ...
      <?php foreach ($categories as $category) { ?>
        ...
        <li>
            ...
            <?php } else { ?>
            <div class="miniclock"></div><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?></a>
            <?php } ?>
      ...
      <img class="catImg" src="image/<?php echo $category['image']; ?>" title="<?php echo $category['name']; ?>" alt="<?php echo $category['name']; ?>"width="300">
                ...
                <div class="clearfix"></div>
                <a href="<?php echo $category['href']; ?>" class="button"><?php echo $goto_text; ?> <?php echo $category['name']; ?></a>
            </div><!--/submenu-->
            <?php } ?>
        </li>
