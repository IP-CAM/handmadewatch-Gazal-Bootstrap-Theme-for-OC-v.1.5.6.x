...
<h2 class="cat-title"><?php echo $category_name; ?><?php if (!isset($this->request->get['path'])) { ?> - <a href="<?php echo $category_url; ?>">показать все</a><?php } ?>
</h2>
    ...
    <div class="box-content">
        ...
        <div class="box-product">
            ...
            <?php foreach ($products as $product) { ?>
                <li id="liorder<?php echo $product['product_id']; ?>" onmouseover="document.getElementById('fast_order<?php echo $product['product_id']; ?>').style.display='block';" onmouseout="document.getElementById('fast_order<?php echo $product['product_id']; ?>').style.display='none';">
                    <div class="main2">
                      <!-- image //
                        =============-->
                        <!--for swap image-->
					  ...
					  <?php 
							if (($product['quantity'] < 1) && $waitlist_enabled) {
							  if ($product['already_in_waitlist']) { 
                                echo $text_already_waitlist;
                              } else { ?>
                                <a id="fast_order<?php echo $product['product_id']; ?>" class="button" style="float:right; margin-left:5px; display:none;" onclick="addToWaitList('<?php echo $product['product_id']; ?>');"><?php echo $product['fast_order']; ?></a>
                              <?php }
                          } else { ?>						  
