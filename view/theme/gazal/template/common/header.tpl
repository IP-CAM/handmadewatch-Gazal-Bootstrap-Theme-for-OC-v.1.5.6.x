...
********************************************/		
		...
		if($this->config->get('gazal_all_addtocart')!='') { ?>
			 a.button, a.ch, a.ca, .sub-menu .button, input.button {
		...
		if($this->config->get('gazal_all_addtocart_hover')!='') { ?>
			a.button:hover, a.ch:hover, a.ca:hover, .sub-menu .button:hover, input.button:hover {
...
********************************************/
		...
		body, p, .mod a { font-family:'Segoe Regular', 'Arial Narrow', Arial, Tahoma; 
		...
		h1, h2, h3, h4, .contentset, legend, .checkout-heading, .welcome {
			font-family:'Segoe Light', 'Arial Narrow', Arial, Tahoma;
		...
		if ($this->config->get('gazal_menu_font') != '') { ?>
		 .top-menu ul li, .top-menu ul li a {
			font-family:'Segoe Regular', 'Arial Narrow', Arial, Tahoma;
			font-size: <?php echo $this->config->get('gazal_menu_font_size'); ?>px;
		}
		<?php }
		/** product Fonts **/
		...
		if ($this->config->get('gazal_price_font') != '') { ?>
		 .box-product .price {
			font-family:'Rain', 'Arial Narrow', Arial, Tahoma !important;
	    ...
	    .box-heading {
			font-family:'Segoe Light', 'Arial Narrow', Arial, Tahoma !important;
...
<!--**************************************************************************************************************-->
 ...
 <link rel="stylesheet" href="catalog/view/theme/gazal/stylesheet/carousel1.css" media="screen" />
 
 <!--<script type="text/javascript" src="catalog/view/javascript/jquery/jquery.js"></script>-->
<script type="text/javascript" src="catalog/view/javascript/jquery/jquery.jbcallme.js"></script>
<link rel="stylesheet" type="text/css" href="catalog/view/theme/gazal/stylesheet/jquery.jbcallme.css">
    ...
    <header>
      ...
      <div class="strip grid_12">
        ...
        <div class="links">
		  ...
		  <a href="index.php?route=information/information&information_id=4">ОБ ИНТЕРНЕТ-МАГАЗИНЕ</a>
		  <a href="index.php?route=account/return/insert">ГАРАНТИЯ КАЧЕСТВА</a>
		  <a href="index.php?route=news/headlines">НОВОСТИ И АКЦИИ</a>
		  <a href="">ИНТЕРЕСНО</a>
         
      </div>
    <div id="currency">
	<b>+7 (963) 63-53-000</b><br>ежедневно (с 9:00 до 18:00)
	</div>
      ...
      <div class="grid_6">
      	...
      	<ul class="top-blocks1">   
<li>
<div class="mazok"></div>
<?php if ($this->cart->countProducts() > 0) { ?>
<div id="ex" style="display: block"></div>
<?php } else { ?>
<div id="ex" style="display: none"></div>
<?php } ?>
<div class="blok">
<a href="<?php echo $checkout; ?>"><img src="cart.png"></a>
			<?php echo $cart; ?>
			</div>
			</li>		
			...
			<div class="mazok"></div>
			<div class="blok">
            	<a class="callme_button" data-name="<?php echo $this->customer->getFirstName(); ?>"><img src="call.png"></a>
				</div>
            </li>
			<li>
			<div class="mazok"></div>
			<div class="blok">
            	<a href="mailto:handmadewatch@mail.ru"><img src="letter.png"></a>
				</div>
            </li>
        </ul>
	...
	<span class="remen"></span>
    	<ul>
        	<?php if ($categories) { ?>
            <li><a href="#">Наручные часы</a>
            	<div class="cat-wrap">
			...
			<li><a href="#">Аксессуары</a>
				...
				<div class="strochka"></div>
            </li>
            <?php } ?>
            <li><a href="index.php?route=information/information&information_id=4">Доставка/Оплата</a><div class="strochka"></div></li>
            <li><a href="index.php?route=information/faq">Вопросы/Ответы</a><div class="strochka"></div></li>
            
            <li><a href="index.php?route=information/contact"><?php echo $text_contact; ?></a><div class="strochka"></div></li>           
        </ul>
		<!-- Search -->
    <div class="search">
        <div id="search">
