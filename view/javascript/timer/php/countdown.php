...
function convert_to_time(secs)
{
  ...
  if (dd < 10) { dd = "0"+dd; }
	...
	return ("<span class='county-days-wrapper first'><span class='county-days'>"+dd+"</span></span><span class='county-hours-wrapper separator-left border-separator-right'><span class='county-hours'>"+hh+"</span></span><span class='county-minutes-wrapper separator-left separator-left'><span class='county-minutes'>"+mm+"</span></span><span class='county-seconds-wrapper separator-left last'><span class='county-seconds'>"+ss+"</span></span><div class='clear'></div><span class='county-label-days'>дни</span><span class='county-label-hours'>часы</span><span class='county-label-minutes'>мин</span><span class='county-label-seconds'>сек</span>");
}
...
document.write("<div class='date-out county gray' id='cd'></div>\n");
