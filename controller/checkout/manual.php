			...
			if (isset($this->request->post['order_product'])) {
				foreach ($this->request->post['order_product'] as $order_product) {
					...
					if ($product_info) {	
						...
						$this->cart->add($order_product['product_id'], $order_product['quantity'], $option_data, $customer_info['customer_id']);
					}
				}
			}
			...
			if (isset($this->request->post['product_id'])) {
				...
				if ($product_info) {
					...
					if (!isset($json['error']['product']['option'])) {
						$this->cart->add($this->request->post['product_id'], $quantity, $option,$customer_info['customer_id']);
					}
				}
			}
