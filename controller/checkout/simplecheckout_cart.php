    ...
    public function index() {
       ...
       // $cart_weight = $this->cart->getWeight();
		...
		if ($this->cart->countProducts() > 0) {
            ...
            $this->data['cart_total'] = sprintf($this->language->get('text_items'), $this->cart->countProducts() + (isset($this->session->data['vouchers']) ? count($this->session->data['vouchers']) : 0), $pref, $this->currency->format($total));		
        }
