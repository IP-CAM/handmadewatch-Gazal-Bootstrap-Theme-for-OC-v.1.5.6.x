...
$search_model = 'model_catalog_search_suggestion';				
			...
			$product_total = $this->$search_model->getTotalProducts($data);
		
			$results = $this->$search_model->getProducts($data);
			
			//$results = $this->model_catalog_product->getProducts($data);
					
			foreach ($results as $result) {
			$res = $this->model_catalog_product->getSborka($result['product_id']);		
				if ($res['quantity'] == 0) {
			...
			$limits = array_unique(array(16, 28, 56, 84, 112));
