<?php  
class ControllerProductlpbc extends Controller {
	...
	static $lpbc = 0;
		...
		$this->data['products'] = array();
			...
			//echo $this->data['button_cart'][$result['product_id'];
			}
			//echo $this->data['products'][0]['name'];
		$this->data['lpbc'] = $lpbc; 

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/lpbc.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/product/lpbc.tpl';
		} else {
